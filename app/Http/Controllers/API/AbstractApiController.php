...
{
    private SentryHandlerInterface $logger;
    ...
    {
        $this->logger = \app()->make(SentryHandlerInterface::class);
    }
    ...
    {
        $this->logger->log($data['message'], new Severity('error'));
    ...
    {
        return $this->respondError($data['message'], Response::HTTP_UNAUTHORIZED);
    }
    ...
    {
        $this->logger->log($data['message'], new Severity('info'));
    ...
    {
        $this->logger->log($message, new Severity('error'));
    ...
    {
        $this->logger->reportError($throwable);
    }
}
